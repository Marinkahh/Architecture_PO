...
public class RobotApi {
     ...
     * @param robotId robotId - идентификатор робота-пылесоса (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateRobotCall(Long robotId, String robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/Robot/updateById/{robotId}"
            .replaceAll("\\{" + "robotId" + "\\}", apiClient.escapeString(robotId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateRobotValidateBeforeCall(Long robotId, String robotId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'robotId' is set
        if (robotId == null) {
            throw new ApiException("Missing the required parameter 'robotId' when calling updateRobot(Async)");
        }
        
        com.squareup.okhttp.Call call = updateRobotCall(robotId, robotId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot updateRobot(Long robotId, String robotId) throws ApiException {
        ApiResponse<Robot> resp = updateRobotWithHttpInfo(robotId, robotId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> updateRobotWithHttpInfo(Long robotId, String robotId) throws ApiException {
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(robotId, robotId, null, null);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateRobotAsync(Long robotId, String robotId, final ApiCallback<Robot> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateRobotValidateBeforeCall(robotId, robotId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Robot>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
